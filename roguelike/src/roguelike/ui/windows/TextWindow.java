...
public class TextWindow {
    ...
    private static Symbol[] doubleLines = new Symbol[] { Symbol.BOX_TOP_LEFT_DOUBLE,
            Symbol.BOX_BOTTOM_LEFT_DOUBLE, Symbol.BOX_TOP_RIGHT_DOUBLE,
            Symbol.BOX_BOTTOM_RIGHT_DOUBLE, Symbol.BOX_TOP_DOUBLE, Symbol.BOX_LEFT_DOUBLE };

    private static Symbol[] singleLines = new Symbol[] { Symbol.BOX_TOP_LEFT_SINGLE,
            Symbol.BOX_BOTTOM_LEFT_SINGLE, Symbol.BOX_TOP_RIGHT_SINGLE,
            Symbol.BOX_BOTTOM_RIGHT_SINGLE, Symbol.BOX_TOP_SINGLE, Symbol.BOX_LEFT_SINGLE };
