...
public class WeaponFactory {
  ...
  private void createMeleeWeapons() {
    weaponBuilders.put(WeaponType.AXE,
        () -> WeaponBuilder.melee("axe", "slashes at %s", ']', SColor.LIGHT_BLUE)
            ...
            .withTargetNumberAndDamageValue(DamageType.BLUNT, 6, 0).withReach(MeleeRange.MEDIUM)
            .withDroppable(true).withDefenseTargetNumber(9).build());

    weaponBuilders.put(WeaponType.DAGGER,
        () -> WeaponBuilder.melee("dagger", "stabs at %s", ']', SColor.LIGHT_BLUE)
    ...
    weaponBuilders.put(WeaponType.SHORT_SWORD,
        () -> WeaponBuilder.melee("short sword", "slashes at %s", ']', SColor.LIGHT_BLUE)
    ...
    weaponBuilders.put(WeaponType.SPEAR,
        () -> WeaponBuilder.melee("spear", "stabs at %s", ']', SColor.LIGHT_BLUE)
  ...
  private void createProjectiles() {
    weaponBuilders.put(WeaponType.ARROW,
        () -> WeaponBuilder.projectile("arrow", "shoots %s", '/', SColor.BRONZE)
            ...
            .withTargetNumberAndDamageValue(DamageType.PIERCING, 6, 0).withReach(MeleeRange.SHORT)
  ...
  private void createNaturalWeapons() {
    ...
    weaponBuilders.put(WeaponType.MANDIBLES,
        () -> WeaponBuilder.melee("mandibles", "slices %s with its mandibles", 'm', SColor.RED)
            .withDescription("Large razor sharp mandibles.").withCategory(WeaponCategory.NATURAL)
            .withDefaultDamageType(DamageType.SLASHING)
            .withTargetNumberAndDamageValue(DamageType.SLASHING, 6, 1)
