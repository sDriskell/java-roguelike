...
public abstract class Actor implements Serializable {
    ...
    public int effectiveSpeed(MapArea map) {
        ...
        speed = Math.max(1, speed + tileSpeedModifier); // always at least 1 speed even if 0 or
                                                        // negative
    ...
    public final void dead() {
        ...
        /* display bloodstain */
        currentArea.getTileAt(this.getPosition())
                .setBackground(SColorFactory.dimmer(SColor.DARK_RED));
